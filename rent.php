...
<body class="rent-image">
    ...
    <section id="rent" class="mx-3 my-5 pt-5 animated fadeInRightBig">
        <!-- Movie Genre -->
        <h3 class="h3-responsive my-3 text-center">POPULAR MOVIES</h3>
        <hr class "my-2">
        <!-- Card deck -->
        <div class="card-deck">
            <!-- Card -->
            <div class="card mb-4">
                ...
                <div class="view overlay zoom">
                    <img class="card-img-top" src="img/12-strong-rent.jpg" alt="Card image cap">
                    <a href="#!">
                ...
                <div class="card-body">
                    <!--Title-->
                    <h4 class="card-title">₦50.00</h4>
                    <!-- Provides extra visual weight and identifies the primary action in a set of buttons -->
                    <button type="button" class="btn btn-amber btn-md">Rent</button>
                </div>
            ...
            <div class="card mb-4">
                ...
                <!--Card image-->
                <div class="view overlay zoom">
                    <img class="card-img-top" src="img/black-panther-rent.jpg" alt="Card image cap">
                    <a href="#!">
                        <div class="mask rgba-white-slight"></div>
                    </a>
                </div>
            ...
            <div class="card mb-4">
                ...
                <!--Card image-->
                <div class="view overlay zoom">
                    <img class="card-img-top " src="img/rampage-rent.jpg" alt="Card image cap">
                    <a href="#!">
                        <div class="mask rgba-white-slight"></div>
                    </a>
                </div>
            ...
            <div class="card mb-4">
                ...
                <!--Card image-->
                <div class="view overlay zoom">
                    <img class="card-img-top" src="img/star-wars-rent.jpeg" alt="Card image cap">
                    <a href="#!">
                        <div class="mask rgba-white-slight"></div>
                    </a>
                </div>
            ...
            <div class="card mb-4">
                ...
                <!--Card image-->
                <div class="view overlay zoom">
                    <img class="card-img-top" src="img/avatar-2-rent.jpg" alt="Card image cap">
                    <a href="#!">
                        <div class="mask rgba-white-slight"></div>
                    </a>
                </div>
        ...
        <!-- Card deck -->
        <!-- Movie Genre -->
        <h3 class="h3-responsive my-5 text-center">MOST DOWNLOADED MOVIES</h3>
        <hr class "my-2">
        <!-- Card deck -->
        <div class="card-deck ">
            <!-- Card -->
            <div class="card mb-4">
                <!--Card image-->
                <div class="view overlay zoom">
                    <img class="card-img-top" src="img/oceans-8-rent.jpg" alt="Card image cap">
                    <a href="#!">
                        <div class="mask rgba-white-slight"></div>
                    </a>
                </div>
            ...
            <div class="card mb-4">
                ...
                <!--Card image-->
                <div class="view overlay zoom">
                    <img class="card-img-top" src="img/predator-rent.jpg" alt="Card image cap">
                    <a href="#!">
                        <div class="mask rgba-white-slight"></div>
                    </a>
                </div>
            ...
            <div class="card mb-4">
                ...
                <!--Card image-->
                <div class="view overlay zoom">
                    <img class="card-img-top" src="img/sherlockgnomes-rent.jpg" alt="Card image cap">
                    <a href="#!">
                        <div class="mask rgba-white-slight"></div>
                    </a>
                </div>
            ...
            <div class="card mb-4">
                ...
                <!--Card image-->
                <div class="view overlay zoom">
                    <img class="card-img-top" src="img/ted-rent.jpg" alt="Card image cap">
                    <a href="#!">
                        <div class="mask rgba-white-slight"></div>
                    </a>
                </div>
            ...
            <div class="card mb-4">
                ...
                <!--Card image-->
                <div class="view overlay zoom">
                    <img class="card-img-top" src="img/avengers-rent.jpg" alt="Card image cap">
                    <a href="#!">
                        <div class="mask rgba-white-slight"></div>
                    </a>
                </div>
