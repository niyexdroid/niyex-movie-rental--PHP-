...
<body>
    <!--Navbar-->
    <nav class="navbar navbar-expand-lg navbar-dark warning-color font-weight-bold fixed-top">
        <!-- Navbar brand -->
    ...
    <div class="mt-5 pt-5" >
        <p class="text-center mt-5" >A CONFIRMATION EMAIL HAS BEEN SENT TO YOU.<br> THANK YOU FOR YOUR PATRONAGE,<br> HAVE A NICE A DAY.</p>
    </div>
    </section>    
     <!-- Footer -->
    <footer class="page-footer font-small warning-color pt-4 fixed-bottom">
        <!-- Footer Text -->
